...
export default function Home() {
  ...
  const siteUrl = "https://riddimafrica.com"; // TODO: confirm final production URL
  const shareText =
  ...
  function openInstagram() {
    // No official web intent exists for pre-filled IG posts — copy text,
    // then send them to Instagram to paste it into a Story/DM/bio.
  ...
  const Toast = () => (
    ...
    >
      <div className="flex items-center gap-2.5 rounded-full bg-[#1F2A2A] border border-[#28C7CC]/40 px-5 py-3 shadow-lg shadow-black/30">
        <span className="flex items-center justify-center w-5 h-5 rounded-full bg-[#28C7CC] shrink-0">
        ...
        <span className="text-sm font-medium text-[#F0EBE8] font-inter whitespace-nowrap">
