...
//     const siteUrl = "https://riddimafrica.com"; // TODO: replace with real production URL
//     const shareText = "I just joined the Riddim Africa waitlist — the new home for African music. Join me:";

//     function handleSubmit(e: FormEvent) {
//         e.preventDefault();
//         if (!email || !consent) return;
//         setSubmitted(true);
//         // TODO: actual submit to backend/DB happens here
//     }
...
//         } catch {
//             // clipboard blocked (rare) — fail silently, button still shows link on hover
//         }
//     }
...
//         // No web intent exists for pre-filled IG posts/stories — best we can do
//         // is copy the link and send them to Instagram to paste it themselves.
//         handleCopyLink();
...
//                 className="rounded-full bg-[#1877F2] w-10 h-10 flex items-center justify-center hover:opacity-90 transition-opacity"
//             >
//                 <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white"><path d="M22 12.06C22 6.505 17.523 2 12 2S2 6.505 2 12.06c0 5.02 3.657 9.184 8.438 9.94v-7.03H7.898v-2.91h2.54V9.845c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562v1.877h2.773l-.443 2.91h-2.33V22c4.78-.756 8.437-4.92 8.437-9.94z" /></svg>
//             </button>
//             <button
//                 type="button"
//                 onClick={openInstagram}
//                 aria-label="Share on Instagram"
//                 className="rounded-full w-10 h-10 flex items-center justify-center hover:opacity-90 transition-opacity"
...
//                 className="rounded-full bg-[#8C36326B] border border-[#F0EBE81F] h-10 px-4 flex items-center justify-center text-xs text-[#F0EBE8B2] hover:border-brand-teal transition-colors"
//             >
...
//                     The home for African music — where artists connect, sounds travel, and
//                     culture moves.
//                 </p>
...
//                         <p className="text-[#C1D6D7] text-xs">
//                             Know someone who&apos;d want early access too? Share it with them:
//                         </p>
//                         <ShareRow />
//                     </div>
//                 ) : (
...
//                                 By joining, you agree that Riddim Africa may contact you about our
//                                 launch.
//                             </span>
//                         </label>
...
//                     <span className="text-xs text-[#C1D6D7] font-inter">
//                         Or share Riddim Africa now
//                     </span>
//                     <ShareRow />
//                 </div>
//             </section>
